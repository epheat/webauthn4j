...
public class HMACCreateSecretExtensionClientOutput implements ExtensionClientOutput {

    public static final String ID = "hmac-secret";

    private Boolean hmacCreateSecret;

    public HMACCreateSecretExtensionClientOutput(Boolean hmacCreateSecret) {
